...
const KEYWORD_RULES: KeywordRule[] = [
  ...
  // Tiếng Việt – nặng
  {
    pattern: /\b(?:địt|đụ|lồn|cặc|buồi|chịch|đéo|chó chết|mẹ mày|đmm|đm|vkl|vcl|clgt)\b/i,
    label: 'blocked',
    confidence: 0.85,
    reason: 'Vietnamese offensive language (tier-1)',
  },
  {
    pattern: /\b(?:giết|chém|đâm|bắn|giết chết|giết mày)\b/i,
    label: 'blocked',
    confidence: 0.80,
  ...
  // English – blocked
  {
    pattern: /\b(?:fuck(?:ing|er|ers)?|shit|bitch|cunt|nigger|faggot|kys|kill yourself)\b/i,
    label: 'blocked',
    confidence: 0.82,
    reason: 'English offensive language (tier-1)',
  },
  {
    pattern: /\b(?:bomb|terrorist|rape|molest(?:ed|ing)?|child porn|cp )\b/i,
    label: 'blocked',
    confidence: 0.95,
  ...
  // Spam / scam signals
  {
    pattern: /(?:click here now|free money|win \$|you(?:'ve| have) won|bank account|send me your)/i,
    label: 'blocked',
    confidence: 0.75,
  ...
  // Tiếng Việt – vừa
  {
    pattern: /\b(?:ngu|khùng|điên|thằng|con đĩ|mất dạy|súc vật|đồ chó)\b/i,
    label: 'warning',
    confidence: 0.55,
  ...
  {
    pattern: /\b(?:suicide|self.?harm|cut myself|want to die|end my life)\b/i,
    label: 'warning',
    confidence: 0.65,
  ...
  // Hate speech
  {
    pattern: /\b(?:hate (?:you|all |every)|racist|homophobic|transphobic)\b/i,
    label: 'warning',
    confidence: 0.50,
